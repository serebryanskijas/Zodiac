...
public class Zodiac {
    ...
    public static void main(String[] args) throws ParseException {
        ...
        //System.out.printf("Month: %s, day: %s%n",calendar.get(Calendar.MONTH),calendar.get(Calendar.DAY_OF_MONTH));1
        ...
        ResourceBundle bundleRu = ResourceBundle.getBundle("com.company/data/Sign", localeRu);
        String signRU = bundleRu.getString(signs[sign]);
        System.out.println(signRU);
        ResourceBundle bundleUS = ResourceBundle.getBundle("com.company/data/Sign", localeUS);
